    ...
    public class APIManager
    {
        ...
        public async Task<LocationModel> GetLocationAsync(string cityName)
        {
            try
            {
                ...
                {
                    throw new Exception("Unable to get location data from Google Geocode API.");
                }
            }
            catch (Exception ex)
            {
                throw new Exception("Error occurred while getting location data.", ex);
            }
        ...
        public async Task<WeatherDataModel> GetWeatherDataAsync(LocationModel location)
        {
            try
            {
                ...
                {
                    throw new Exception("Unable to get weather data from OpenWeatherMap API.");
                }
            }
            catch (Exception ex)
            {
